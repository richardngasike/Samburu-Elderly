...
const goals = [
  { icon: '💊', text: 'Medication Access & Adherence' },
  { icon: '🧠', text: 'Psychosocial Wellbeing' },
  { icon: '🏠', text: 'Basic Needs Provision' },
  { icon: '💧', text: 'Water & Sanitation' },
  { icon: '📚', text: 'Capacity Building' },
  { icon: '🤲', text: 'Social Care' },
  { icon: '🌾', text: 'Food Security' },
  { icon: '🏛️', text: 'Institutional Strengthening' },
];
